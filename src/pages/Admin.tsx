...
const ROLE_PRESETS: Record<string, ModuleKey[]> = {
  ...
  "Sales Executive": ["dashboard","calling_crm","paid_pipeline","follow_up_command_center","lead-qualifier","reports"],
  "Sales Agent": ["dashboard","calling_crm","lead-qualifier"],
  "Sales Manager": ["dashboard","calling_crm","paid_pipeline","follow_up_command_center","lead-qualifier","reports","search"],
  ...
  "Finance Executive": ["dashboard","reports","profit-statement","master-data","follow_up_command_center"],
