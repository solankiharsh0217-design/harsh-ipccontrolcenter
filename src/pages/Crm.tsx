      ...
      <div className="fixed bottom-0 left-[228px] right-0 bg-white border-t border-line px-10 py-2.5 flex items-center gap-2 z-40 overflow-x-auto">
        {pipelines.map((p) => {
          ...
          return (
            ...
            >
              <button onClick={() => { if (p.type === "operations") { navigate("/operations-crm"); return; } setActivePipeline(p.id); }} className="px-3 py-1.5 text-xs flex items-center gap-1.5" title={p.type === "operations" ? "Open standalone Operations CRM" : undefined}>
